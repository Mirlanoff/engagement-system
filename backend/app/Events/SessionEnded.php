...
_id' => $this->session->id, 'avg_score' => $this->session->avg_engagement_score, 'duration_minutes' => $this->session->duration_minutes, 'ended_at' => $this->session->ended_at?->toIso8601String(), ]; } } EOF

```bash
cat > backend/app/Events/SessionPaused.php << 'EOF'
<?php
