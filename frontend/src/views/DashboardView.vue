<template>
  <div class="dashboard">
    ...
    <!--
      ...
      Панель видна только на вкладке «Обзор», но компонент остаётся
      смонтированным (v-show), чтобы захват кадров не прерывался при
      переключении на «Аналитика», «История» и т.д.
    -->
    <WebcamCapture
